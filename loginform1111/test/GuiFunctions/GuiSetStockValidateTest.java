...
public class GuiSetStockValidateTest {
    ...
    @Test
    //testing that the product name dosen't exist
    public void testEditStock1() {
        String productName = "ahmed";
        int quantity = 10;
        String date = "1/6/2023";
        GuiSetStockValidate instance = new GuiSetStockValidate();
        boolean flag = instance.EditStock(productName, quantity, date);
        assertEquals(false, flag);
    }

    @Test
    public void testEditStock2() {
        String productName = "Aspirin";
        int quantity = 10;
        String date = "25/6/2023";
        GuiSetStockValidate instance = new GuiSetStockValidate();
        boolean flag = instance.EditStock(productName, quantity, date);
    ...
    @Test
    public void testEditStock3() {
        String productName = "Band-Aid";
        int quantity = 10;
        String date = "25/6/2023";
        GuiSetStockValidate instance = new GuiSetStockValidate();
        boolean flag = instance.EditStock(productName, quantity, date);
        ...
        @Test
    public void testEditStock4() {
        String productName = "Band-Aid";
        int quantity = 10;
        String date = "25/7/2023";
        GuiSetStockValidate instance = new GuiSetStockValidate();
        boolean flag = instance.EditStock(productName, quantity, date);
        assertEquals(true, flag);
    }
            ...
            @Test
    public void testEditStock5() {
        String productName = "Band-Aid";
        int quantity = 10;
        String date = "10/7/2023";
        GuiSetStockValidate instance = new GuiSetStockValidate();
        boolean flag = instance.EditStock(productName, quantity, date);
        assertEquals(true, flag);
    }
